...
#line 704 "susan_edge_detector.h"
class SusanEdges;
...
#line 807 "susan_edge_detector.h"
...
#line 973 "susan_edge_detector.h"
...
#line 26 "susan_edge_detector.sc"
class susan : public _specc::behavior
{
private:

#line 26 "susan_edge_detector.sc"
    i_receiver (&start); unsigned char (&image_buffer)[7220]; i_sender (&sd);
public:

#line 1007 "susan_edge_detector.h"
    susan(unsigned int _idcnt, i_receiver (&start), unsigned char (&image_buffer)[7220], i_sender (&sd));
    virtual ~susan(void);
    void main(void);
private:

#line 28 "susan_edge_detector.sc"
    unsigned char mid[7220];

#line 27 "susan_edge_detector.sc"
    int r[7220];
...
#line 31 "susan_edge_detector.sc"
    SusanThin S;
};

#line 46 "susan_edge_detector.sc"
...
#line 47 "susan_edge_detector.sc"
    const unsigned long int SIZE;
...
#line 51 "susan_edge_detector.sc"
...
#line 1956 "susan_edge_detector.h"
