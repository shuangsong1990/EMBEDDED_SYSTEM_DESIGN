...
class EdgeDraw;
class SusanThin;
class i_r_tranceiver;

#line 3 "./c_type_define.sc"
/* note i_r_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","r","int" }; */

#line 717 "design.h"
class i_r_sender;

#line 4 "./c_type_define.sc"
/* note i_r_sender._SCE_STANDARD_LIB = { "i_sender","r","int" }; */

#line 723 "design.h"
class i_r_receiver;

#line 5 "./c_type_define.sc"
/* note i_r_receiver._SCE_STANDARD_LIB = { "i_receiver","r","int" }; */

#line 729 "design.h"
class c_r_queue;

#line 6 "./c_type_define.sc"
/* note c_r_queue._SCE_STANDARD_LIB = { "c_queue","r","int" }; */

#line 735 "design.h"
class i_mid_tranceiver;

#line 8 "./c_type_define.sc"
/* note i_mid_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","mid","unsigned char" }; */

#line 741 "design.h"
class i_mid_sender;

#line 9 "./c_type_define.sc"
/* note i_mid_sender._SCE_STANDARD_LIB = { "i_sender","mid","unsigned char" }; */

#line 747 "design.h"
class i_mid_receiver;

#line 10 "./c_type_define.sc"
/* note i_mid_receiver._SCE_STANDARD_LIB = { "i_receiver","mid","unsigned char" }; */

#line 753 "design.h"
class c_mid_queue;

#line 11 "./c_type_define.sc"
/* note c_mid_queue._SCE_STANDARD_LIB = { "c_queue","mid","unsigned char" }; */

#line 759 "design.h"
class i_in_tranceiver;

#line 14 "./c_type_define.sc"
/* note i_in_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","in","unsigned char" }; */

#line 765 "design.h"
class i_in_sender;

#line 15 "./c_type_define.sc"
/* note i_in_sender._SCE_STANDARD_LIB = { "i_sender","in","unsigned char" }; */

#line 771 "design.h"
class i_in_receiver;

#line 16 "./c_type_define.sc"
/* note i_in_receiver._SCE_STANDARD_LIB = { "i_receiver","in","unsigned char" }; */

#line 777 "design.h"
class c_in_queue;

#line 17 "./c_type_define.sc"
/* note c_in_queue._SCE_STANDARD_LIB = { "c_queue","in","unsigned char" }; */
...
#line 874 "design.h"
    virtual ~i_mid_tranceiver(void){};

#line 8 "./c_type_define.sc"
    virtual void receive(unsigned char *) = 0; virtual void send(unsigned char) = 0;
private:
};
...
#line 17 "./DetectEdges.sc"
class cal_mid_thread : public _specc::behavior
{
private:

#line 18 "./DetectEdges.sc"
...
#line 1013 "design.h"
    cal_mid_thread(unsigned int _idcnt, unsigned char (&mid)[7220], unsigned char (&in_sc)[7220], unsigned char (&bp)[516], int (&r)[7220], int (&sp), int (&ep), int (&max_no));
    virtual ~cal_mid_thread(void);
    int cir_mask(unsigned char [7220], unsigned char [516], int, int, int);
    void main(void);
private:
};

#line 157 "./DetectEdges.sc"
class cal_r_thread : public _specc::behavior
{
private:

#line 158 "./DetectEdges.sc"
    int (&r)[7220];
    unsigned char (&in_sc)[7220];
    unsigned char (&bp)[516];
    int (&row_start);
...
#line 1035 "design.h"
    cal_r_thread(unsigned int _idcnt, int (&r)[7220], unsigned char (&in_sc)[7220], unsigned char (&bp)[516], int (&row_start), int (&row_end), int (&max_no));
    virtual ~cal_r_thread(void);
    int cir_mask(unsigned char [7220], unsigned char [516], int, int, int);
    void main(void);
private:
};

#line 244 "./DetectEdges.sc"
class SusanEdges : public _specc::behavior
{
private: unsigned char (&in_sc)[7220];
    int (&r)[7220];
    unsigned char (&mid)[7220];
    unsigned char (&bp)[516];
public:
...
#line 1052 "design.h"
    SusanEdges(unsigned int _idcnt, unsigned char (&in_sc)[7220], int (&r)[7220], unsigned char (&mid)[7220], unsigned char (&bp)[516]);
    virtual ~SusanEdges(void);
    void main(void);
private:

#line 256 "./DetectEdges.sc"
    int max_no;

    unsigned char mid_thread1[7220]; unsigned char mid_thread2[7220];

#line 257 "./DetectEdges.sc"
    int r_thread1[7220]; int r_thread2[7220];

#line 252 "./DetectEdges.sc"
    int row_sep;
    int x_end;
    int x_end_2;
...
#line 259 "./DetectEdges.sc"
    cal_r_thread cal_r_thread1;
    cal_r_thread cal_r_thread2;
};

#line 334 "./DetectEdges.sc"
class SetupBrightnessLut : public _specc::behavior
{
private:

#line 335 "./DetectEdges.sc"
    unsigned char (&bp)[516];
public:
...
#line 337 "./DetectEdges.sc"
    int thresh;
};

#line 361 "./DetectEdges.sc"
class DetectEdges : public _specc::behavior
{
private:

#line 362 "./DetectEdges.sc"
...
#line 1114 "design.h"
    DetectEdges(unsigned int _idcnt, i_in_receiver (&in_buffer), i_r_sender (&r_s), i_mid_sender (&mid_s));
    virtual ~DetectEdges(void);
    void main(void);
private:

#line 370 "./DetectEdges.sc"
    unsigned char bp[516];

#line 366 "./DetectEdges.sc"
    unsigned char in_sc[7220];

    unsigned char mid[7220];

#line 367 "./DetectEdges.sc"
    int r[7220];

#line 373 "./DetectEdges.sc"
    SusanEdges Edge;

#line 371 "./DetectEdges.sc"
...
#line 1150 "design.h"
    EdgeDraw(unsigned int _idcnt, i_in_receiver (&in_buffer), i_mid_receiver (&mid_r), int (&drawing_mode), i_in_sender (&sd));
...
#line 12 "./SusanThin.sc"
class SusanThin : public _specc::behavior
{
private:

#line 13 "./SusanThin.sc"
    i_r_receiver (&r_r);
    i_mid_receiver (&mid_r);
    i_mid_sender (&mid_s);
public:
...
#line 1172 "design.h"
    SusanThin(unsigned int _idcnt, i_r_receiver (&r_r), i_mid_receiver (&mid_r), i_mid_sender (&mid_s));
    virtual ~SusanThin(void);
    void main(void);
private:

#line 18 "./SusanThin.sc"
    unsigned char mid[7220];

#line 17 "./SusanThin.sc"
    int r[7220];
};

#line 6 "./c_type_define.sc"
class c_r_queue : public _specc::channel, public i_r_sender, public i_r_receiver, public i_r_tranceiver
{
private:
...
#line 1194 "design.h"
    c_r_queue(const unsigned long int (&size));
    virtual ~c_r_queue(void);
    void cleanup(void);
    void receive(int *);
    void send(int);
    void setup(void);
...
#line 6 "./c_type_define.sc"
    int *buffer; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};



class c_mid_queue : public _specc::channel, public i_mid_sender, public i_mid_receiver, public i_mid_tranceiver
{
private:
...
#line 1217 "design.h"
    c_mid_queue(const unsigned long int (&size));
    virtual ~c_mid_queue(void);
    void cleanup(void);
...
#line 11 "./c_type_define.sc"
    unsigned char *buffer; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};




class c_in_queue : public _specc::channel, public i_in_sender, public i_in_receiver, public i_in_tranceiver
{
private:
...
#line 1241 "design.h"
    c_in_queue(const unsigned long int (&size));
    virtual ~c_in_queue(void);
    void cleanup(void);
    void receive(unsigned char *);
    void send(unsigned char);
    void setup(void);
...
#line 18 "./read_image.sc"
    i_receiver (&start); unsigned char (&in_sc)[7220]; i_in_sender (&sd); i_in_sender (&se);
public:

#line 1305 "design.h"
    rprocess(unsigned int _idcnt, i_receiver (&start), unsigned char (&in_sc)[7220], i_in_sender (&sd), i_in_sender (&se));
    virtual ~rprocess(void);
    void main(void);
private:
};

#line 33 "./read_image.sc"
...
#line 1321 "design.h"
    ReadImage(unsigned int _idcnt, i_receiver (&start), unsigned char (&in_sc)[7220], i_in_sender (&sd), i_in_sender (&se));
    virtual ~ReadImage(void);
    void main(void);
private:

#line 35 "./read_image.sc"
    rprocess r;
};

#line 27 "./susan.sc"
class DetectEdges_wp : public _specc::behavior
{
private:
...
#line 1342 "design.h"
    DetectEdges_wp(unsigned int _idcnt, i_in_receiver (&in_buffer), i_r_sender (&r_s), i_mid_sender (&mid_s));
    virtual ~DetectEdges_wp(void);
    void main(void);
private:
...
#line 41 "./susan.sc"
class SusanThin_wp : public _specc::behavior
{
private:
...
#line 1363 "design.h"
    SusanThin_wp(unsigned int _idcnt, i_r_receiver (&r_r), i_mid_receiver (&mid_r), i_mid_sender (&mid_s));
    virtual ~SusanThin_wp(void);
    void main(void);
private:
...
#line 59 "./susan.sc"
class EdgeDraw_wp : public _specc::behavior
{
private:
...
#line 1384 "design.h"
    EdgeDraw_wp(unsigned int _idcnt, i_in_receiver (&in_buffer), i_mid_receiver (&mid_r), i_in_sender (&sd));
    virtual ~EdgeDraw_wp(void);
    void main(void);
private:
    int _scc_const_port_0;
...
#line 80 "./susan.sc"
    i_in_receiver (&buffer_in_d); i_in_receiver (&buffer_in_e); i_in_sender (&buffer_out);
public:

#line 1404 "design.h"
    susan(unsigned int _idcnt, i_in_receiver (&buffer_in_d), i_in_receiver (&buffer_in_e), i_in_sender (&buffer_out));
    virtual ~susan(void);
    void main(void);
private:

#line 85 "./susan.sc"
    const unsigned long int q_len;
...
#line 1477 "design.h"
    WriteImage(unsigned int _idcnt, i_in_receiver (&rec), i_sender (&sd));
    virtual ~WriteImage(void);
    void main(void);
private:

#line 18 "./write_image.sc"
    unsigned char out_sc[7220];
};
...
#line 39 "design.sc"
    c_in_queue buffer_in_d;
    c_in_queue buffer_in_e;
    c_in_queue buffer_out;
};
