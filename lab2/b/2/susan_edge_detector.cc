...
MasterHardwareBus::MasterHardwareBus(_specc::signal<bit<_BITLEN(15,0),true> > (&A), _specc::signal<bit<_BITLEN(31,0),true> > (&D), _specc::signal<bit<_BITLEN(0,0),true> > (&ready), _specc::signal<bit<_BITLEN(0,0),true> > (&ack))
...
#line 65 "./HWBus.sc"
void MasterHardwareBus::masterRead(bit<_BITLEN(15,0),true> a, bit<_BITLEN(31,0),true> *d)
{   
	...
	_scc_range_check(_scc_time_stamp_t1, _scc_time_stamp_t2, 5000ll, true, 15000ll, true, "t1", "t2", "./HWBus.sc", 78);
	_scc_range_check(_scc_time_stamp_t3, _scc_time_stamp_t4, 10000ll, true, 25000ll, true, "t3", "t4", "./HWBus.sc", 79);
    }
}

#line 47 "./HWBus.sc"
void MasterHardwareBus::masterWrite(bit<_BITLEN(15,0),true> a, bit<_BITLEN(31,0),true> d)
{   
    { unsigned long long _scc_time_stamp_t1, _scc_time_stamp_t2, _scc_time_stamp_t3, _scc_time_stamp_t4; {
	    t1: _scc_time_stamp_t1 = _specc::getCurrentTime(); A = a;
	    D = d;
	...
	_scc_range_check(_scc_time_stamp_t1, _scc_time_stamp_t2, 5000ll, true, 15000ll, true, "t1", "t2", "./HWBus.sc", 60);
	_scc_range_check(_scc_time_stamp_t3, _scc_time_stamp_t4, 10000ll, true, 25000ll, true, "t3", "t4", "./HWBus.sc", 61);
    }
}

#line 66 "susan_edge_detector.cc"
SlaveHardwareBus::SlaveHardwareBus(_specc::signal<bit<_BITLEN(15,0),true> > (&A), _specc::signal<bit<_BITLEN(31,0),true> > (&D), _specc::signal<bit<_BITLEN(0,0),true> > (&ready), _specc::signal<bit<_BITLEN(0,0),true> > (&ack))
    : _specc::channel(), A(A), D(D), ready(ready), ack(ack)
{   /* nothing */
}
...
#line 116 "./HWBus.sc"
void SlaveHardwareBus::slaveRead(bit<_BITLEN(15,0),true> a, bit<_BITLEN(31,0),true> *d)
{   
    { unsigned long long _scc_time_stamp_t1, _scc_time_stamp_t2, _scc_time_stamp_t3, _scc_time_stamp_t4, _scc_time_stamp_t5; {
	    ...
	    t2: _scc_time_stamp_t2 = _specc::getCurrentTime(); if (a != ((bit<_BITLEN(15,0),true>)A)) {
		    _specc::waitfor((1000));
		    goto t1;
		}
		else  {
	...
	_scc_range_check(_scc_time_stamp_t2, _scc_time_stamp_t3, 10000ll, true, 20000ll, true, "t2", "t3", "./HWBus.sc", 134);
	_scc_range_check(_scc_time_stamp_t4, _scc_time_stamp_t5, 5000ll, true, 15000ll, true, "t4", "t5", "./HWBus.sc", 135);
    }
}

#line 93 "./HWBus.sc"
void SlaveHardwareBus::slaveWrite(bit<_BITLEN(15,0),true> a, bit<_BITLEN(31,0),true> d)
{   
    { unsigned long long _scc_time_stamp_t1, _scc_time_stamp_t2, _scc_time_stamp_t3, _scc_time_stamp_t4, _scc_time_stamp_t5; {
	    t1: _scc_time_stamp_t1 = _specc::getCurrentTime(); while( !((ready).test())) _specc::wait(event(&ready), ((void*)0));
	    t2: _scc_time_stamp_t2 = _specc::getCurrentTime(); if (a != ((bit<_BITLEN(15,0),true>)A)) {
	...
	_scc_range_check(_scc_time_stamp_t2, _scc_time_stamp_t3, 10000ll, true, 20000ll, true, "t2", "t3", "./HWBus.sc", 111);
	_scc_range_check(_scc_time_stamp_t4, _scc_time_stamp_t5, 5000ll, true, 15000ll, true, "t4", "t5", "./HWBus.sc", 112);
    }
}

#line 124 "susan_edge_detector.cc"
...
#line 140 "susan_edge_detector.cc"
...
#line 157 "susan_edge_detector.cc"
...
#line 208 "susan_edge_detector.cc"
...
#line 259 "susan_edge_detector.cc"
...
#line 317 "susan_edge_detector.cc"
...
#line 337 "susan_edge_detector.cc"
...
#line 358 "susan_edge_detector.cc"
...
#line 392 "susan_edge_detector.cc"
...
#line 492 "susan_edge_detector.cc"
...
#line 796 "susan_edge_detector.cc"
...
#line 839 "susan_edge_detector.cc"
...
#line 872 "susan_edge_detector.cc"
...
#line 936 "susan_edge_detector.cc"
...
#line 1110 "susan_edge_detector.cc"
...
#line 1129 "susan_edge_detector.cc"
...
#line 1148 "susan_edge_detector.cc"
...
#line 1236 "susan_edge_detector.cc"
...
#line 1364 "susan_edge_detector.cc"
...
#line 1380 "susan_edge_detector.cc"
...
#line 1395 "susan_edge_detector.cc"
...
#line 1422 "susan_edge_detector.cc"
...
#line 1499 "susan_edge_detector.cc"
...
#line 1554 "susan_edge_detector.cc"
...
#line 1577 "susan_edge_detector.cc"
...
#line 1659 "susan_edge_detector.cc"
...
#line 1787 "susan_edge_detector.cc"
...
#line 1815 "susan_edge_detector.cc"
...
#line 1920 "susan_edge_detector.cc"
...
#line 2168 "susan_edge_detector.cc"
...
#line 2185 "susan_edge_detector.cc"
...
#line 2239 "susan_edge_detector.cc"
...
#line 2264 "susan_edge_detector.cc"
...
#line 2497 "susan_edge_detector.cc"
...
#line 2513 "susan_edge_detector.cc"
...
#line 2528 "susan_edge_detector.cc"
...
#line 2556 "susan_edge_detector.cc"
...
#line 2584 "susan_edge_detector.cc"
...
#line 2606 "susan_edge_detector.cc"
