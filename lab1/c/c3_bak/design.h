...
#line 1006 "design.h"
    SusanEdges(unsigned int _idcnt, i_in_receiver (&in_buffer), i_r_sender (&r_s), i_mid_sender (&mid_s), unsigned char (&bp)[516]);
...
#line 199 "./DetectEdges.sc"
    int thresh;
};

#line 223 "./DetectEdges.sc"
class DetectEdges : public _specc::behavior
{
private:

#line 224 "./DetectEdges.sc"
    i_in_receiver (&in_buffer);
    i_r_sender (&r_s);
    i_mid_sender (&mid_s);
public:
